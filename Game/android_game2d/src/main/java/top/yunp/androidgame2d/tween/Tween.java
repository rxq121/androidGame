...
public abstract class Tween {
    ...
    public final EventListenerList<TweenEvent, Tween> tweenStart = new EventListenerList<TweenEvent, Tween>();
    public final EventListenerList<TweenEvent, Tween> tweenEnd = new EventListenerList<TweenEvent, Tween>();
}
