...
public class RectLine extends Container {
    ...
    private EventListener<TweenEvent, Tween> tweenEndHandler = new EventListener<TweenEvent, Tween>() {
        @Override
    ...
    private EventListener<TouchEvent, Display> rectTouchDownHandler = new EventListener<TouchEvent, Display>() {
        @Override
